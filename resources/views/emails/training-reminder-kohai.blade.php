...
<body>
    <div class="wrapper">
        <div class="main-container">
            ...
            <div class="content">
                <div class="badge">
                    🥋 Khusus Kohai (Anggota Dojo)
                </div>

                <h2 class="greeting">Halo, {{ $recipient->name }}! 👋</h2>

                <p class="paragraph">
                    Pemberitahuan pengingat jadwal latihan karate dojo yang akan segera dilaksanakan. Mohon hadir tepat waktu dan persiapkan diri dengan baik.
                </p>
                ...
                <!-- Kohai Checklist Box -->
                <div class="steps-box">
                    <div class="steps-title">📌 Panduan & Persiapan Kohai:</div>
                    <ol class="steps-list">
                        <li>Kenakan seragam karate (Karategi) lengkap dan sabuk (Obi) sesuai tingkatan Anda.</li>
                        <li>Hadir di lokasi latihan minimal 10–15 menit sebelum waktu mulai untuk pemanasan.</li>
                        <li>Lakukan <strong>Scan QR Presensi</strong> melalui aplikasi saat tiba di dojo untuk mencatat kehadiran Anda.</li>
                    </ol>
                </div>
            ...
            <div class="footer">
                ...
                <p><em>"Hitotsu! Reigi o omonzuru koto"</em> — Senantiasa menjunjung tinggi sopan santun dan kedisiplinan.</p>
