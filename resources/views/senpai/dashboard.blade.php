        ...
        <div class="lg:col-span-1 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm p-5 sm:p-6 space-y-4 transition-colors duration-200">
            ...
            <div class="space-y-3">
                @forelse($trainingSchedules as $sched)
                    <div class="p-4 rounded-2xl bg-slate-50/80 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700/80 hover:border-brand-primary/40 dark:hover:border-brand-primary/50 transition-all space-y-2.5">
                        <div class="flex items-center justify-between gap-2">
                            <div class="flex items-center gap-1.5 min-w-0">
                                @if($sched->type === 'rutin')
                                    <span class="px-2 py-0.5 rounded-md text-[10px] font-black uppercase tracking-wider bg-blue-50 dark:bg-blue-950/80 text-brand-primary dark:text-blue-300 border border-blue-200 dark:border-blue-800">
                                        Rutin
                                    </span>
                                @else
