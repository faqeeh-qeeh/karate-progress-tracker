...
<div class="space-y-6">
    <!-- Page Header Header -->
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs transition-colors duration-200">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-xl sm:text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Biodata Pelatih / Senpai</h1>
                <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">Kelola data pribadi dan tingkatan sabuk dojo Anda</p>
            </div>
        </div>
        <div class="flex items-center gap-2">
            @if($profile->rank)
                <span class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold bg-slate-900 dark:bg-slate-800 text-white border border-slate-700 shadow-xs">
            ...
            @else
                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-amber-50 dark:bg-amber-950/50 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-800">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs overflow-hidden transition-colors duration-200">
                    <div class="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center gap-2.5 bg-slate-50/50 dark:bg-slate-950/40">
                        <div class="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-950/60 text-brand-primary dark:text-blue-400 flex items-center justify-center">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                        </div>
                        <div>
                            <h2 class="text-sm font-bold text-slate-800 dark:text-slate-200">Informasi Pribadi & Kontak</h2>
                            <p class="text-[11px] text-slate-500 dark:text-slate-400">Data identitas utama akun Senpai</p>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}" required
                                ...
                                class="w-full px-4 py-2.5 rounded-xl border @error('name') border-red-500 bg-red-50/30 dark:bg-red-950/20 @else border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 @enderror text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition">
                            @error('name')
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}" required
                                    ...
                                    class="w-full px-4 py-2.5 rounded-xl border @error('email') border-red-500 bg-red-50/30 dark:bg-red-950/20 @else border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 @enderror text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition">
                                @error('email')
                                    <p class="text-xs text-red-600 dark:text-red-400 mt-1 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone" id="phone" value="{{ old('phone', $user->phone) }}" required
                                    ...
                                    class="w-full px-4 py-2.5 rounded-xl border @error('phone') border-red-500 bg-red-50/30 dark:bg-red-950/20 @else border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 @enderror text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition">
                                @error('phone')
                                    <p class="text-xs text-red-600 dark:text-red-400 mt-1 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="birth_place" id="birth_place" value="{{ old('birth_place', $user->birth_place) }}" required
                                    ...
                                    class="w-full px-4 py-2.5 rounded-xl border @error('birth_place') border-red-500 bg-red-50/30 dark:bg-red-950/20 @else border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 @enderror text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition">
                                @error('birth_place')
                                    <p class="text-xs text-red-600 dark:text-red-400 mt-1 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date', $user->birth_date?->format('Y-m-d')) }}" required
                                    class="w-full px-4 py-2.5 rounded-xl border @error('birth_date') border-red-500 bg-red-50/30 dark:bg-red-950/20 @else border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 @enderror text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition">
                                @error('birth_date')
                                    <p class="text-xs text-red-600 dark:text-red-400 mt-1 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <select name="gender" id="gender" required
                                class="w-full px-4 py-2.5 rounded-xl border @error('gender') border-red-500 bg-red-50/30 dark:bg-red-950/20 @else border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 @enderror text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition">
                        ...
                        <div>
                            ...
                            <textarea name="address" id="address" rows="3" required
                                ...
                                class="w-full px-4 py-2.5 rounded-xl border @error('address') border-red-500 bg-red-50/30 dark:bg-red-950/20 @else border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 @enderror text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition resize-none">{{ old('address', $user->address) }}</textarea>
                            @error('address')
                                <p class="text-xs text-red-600 dark:text-red-400 mt-1 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs overflow-hidden transition-colors duration-200">
                    <div class="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center gap-2.5 bg-slate-50/50 dark:bg-slate-950/40">
                        ...
                        <div>
                            <h2 class="text-sm font-bold text-slate-800 dark:text-slate-200">Keamanan & Kata Sandi</h2>
                            <p class="text-[11px] text-slate-500 dark:text-slate-400">Kosongkan jika tidak ingin mengubah kata sandi. Wajib menyertakan kata sandi lama jika ingin memperbarui.</p>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="password" name="current_password" id="current_password"
                                ...
                                class="w-full px-4 py-2.5 rounded-xl border @error('current_password') border-red-500 bg-red-50/30 dark:bg-red-950/20 @else border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 @enderror text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="password" name="password" id="password"
                                    ...
                                    class="w-full px-4 py-2.5 rounded-xl border @error('password') border-red-500 bg-red-50/30 dark:bg-red-950/20 @else border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 @enderror text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition">
                                @error('password')
                                    <p class="text-xs text-red-600 dark:text-red-400 mt-1 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="password" name="password_confirmation" id="password_confirmation"
                                    ...
                                    autocomplete="new-password"
                                    class="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs overflow-hidden transition-colors duration-200">
                    <div class="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center gap-2.5 bg-slate-50/50 dark:bg-slate-950/40">
                        <div class="w-8 h-8 rounded-lg bg-red-50 dark:bg-red-950/50 text-red-600 dark:text-red-400 flex items-center justify-center">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>
                        </div>
                        <div>
                            <h2 class="text-sm font-bold text-slate-800 dark:text-slate-200">Tingkat Sabuk Senpai</h2>
                            <p class="text-[11px] text-slate-500 dark:text-slate-400">Tingkatan sabuk dojo (opsional)</p>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <select name="rank_id" id="rank_id"
                                class="w-full px-4 py-2.5 rounded-xl border @error('rank_id') border-red-500 bg-red-50/30 dark:bg-red-950/20 @else border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-950/50 @enderror text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition cursor-pointer disabled:bg-slate-100/80 dark:disabled:bg-slate-800 disabled:cursor-not-allowed disabled:text-slate-400 dark:disabled:text-slate-500">
                        ...
                        <div class="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950/50 border border-slate-200/80 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-400 leading-relaxed space-y-1.5">
                ...
                <!-- Submit Button Card -->
                <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-5 shadow-xs space-y-3 transition-colors duration-200">
                    <button type="submit"
