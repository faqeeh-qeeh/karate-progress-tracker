...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/80 shadow-xs">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight">Biodata Kohai / Anggota</h1>
                <p class="text-xs sm:text-sm text-slate-500 mt-0.5">Kelola data akademik, asal keanggotaan, sabuk, dan data fisik Anda</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                @if($profile->type === 'polindra')
                    <div class="p-5 rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50/50 border border-blue-200/90 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xs">
                        <div class="flex items-center gap-3.5">
                            ...
                            <div>
                                <span class="text-[10px] font-black uppercase tracking-widest text-brand-primary">Kategori Keanggotaan</span>
                                <h2 class="text-sm sm:text-base font-extrabold text-slate-900">Mahasiswa / Sivitas Polindra</h2>
                                <p class="text-[11px] text-slate-600 mt-0.5">Status anggota resmi Politeknik Negeri Indramayu (Ditetapkan oleh Admin Dojo)</p>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 space-y-4">
                        <div class="flex items-center gap-2.5 pb-3 border-b border-slate-100">
                            <div class="w-8 h-8 rounded-lg bg-blue-50 text-brand-primary flex items-center justify-center font-bold text-xs">
                                1
                            </div>
                            <div>
                                <h2 class="text-sm font-bold text-slate-800">Data Akademik Polindra</h2>
                                <p class="text-[11px] text-slate-500">Lengkapi data Jurusan, Program Studi, Kelas, NIM, dan Angkatan</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="nim" id="nim" value="{{ old('nim', $profile->nim) }}" required
                                    ...
                                    class="w-full px-4 py-2.5 rounded-xl border @error('nim') border-red-500 bg-red-50/30 @else border-slate-200 bg-slate-50/50 @enderror text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white transition">
                                @error('nim')
                            ...
                            <div>
                                <label for="enrollment_year" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
                                ...
                                <input type="number" name="enrollment_year" id="enrollment_year" min="2000" max="{{ date('Y') + 1 }}" required
                                    ...
                                    class="w-full px-4 py-2.5 rounded-xl border @error('enrollment_year') border-red-500 bg-red-50/30 @else border-slate-200 bg-slate-50/50 @enderror text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white transition">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <!-- Jurusan -->
                            <div>
                                <label for="department_id" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
                                    Jurusan
                                </label>
                            ...
                            <!-- Program Studi -->
                            <div>
                                <label for="study_program_id" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
                                    Program Studi <span class="text-red-500">*</span>
                                </label>
                                <select name="study_program_id" id="study_program_id" onchange="filterAcademicClasses(true)" required
                                    class="w-full px-4 py-2.5 rounded-xl border @error('study_program_id') border-red-500 bg-red-50/30 @else border-slate-200 bg-slate-50/50 @enderror text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white transition cursor-pointer disabled:bg-slate-100/80 disabled:cursor-not-allowed disabled:text-slate-400">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <!-- Kelas -->
                            <div>
                                <label for="academic_class_id" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
                                    Kelas <span class="text-red-500">*</span>
                                </label>
                                <select name="academic_class_id" id="academic_class_id" required
                                    class="w-full px-4 py-2.5 rounded-xl border @error('academic_class_id') border-red-500 bg-red-50/30 @else border-slate-200 bg-slate-50/50 @enderror text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white transition cursor-pointer disabled:bg-slate-100/80 disabled:cursor-not-allowed disabled:text-slate-400">
                            ...
                            <!-- Asal SMA/SMK -->
                            <div>
                                <label for="high_school" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
                                ...
                                <input type="text" name="high_school" id="high_school" value="{{ old('high_school', $profile->high_school) }}" required
                                    ...
                                    class="w-full px-4 py-2.5 rounded-xl border @error('high_school') border-red-500 bg-red-50/30 @else border-slate-200 bg-slate-50/50 @enderror text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white transition">
                                @error('high_school')
                                    <p class="text-xs text-red-600 mt-1 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                @else
                    <div class="p-5 rounded-2xl bg-gradient-to-r from-amber-50 to-orange-50/50 border border-amber-200/90 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xs">
                        <div class="flex items-center gap-3.5">
                            ...
                            <div>
                                <span class="text-[10px] font-black uppercase tracking-widest text-amber-700">Kategori Keanggotaan</span>
                                <h2 class="text-sm sm:text-base font-extrabold text-slate-900">Luar Polindra / Instansi Lain</h2>
                                <p class="text-[11px] text-slate-600 mt-0.5">Anggota dari sekolah luar atau instansi umum (Ditetapkan oleh Admin Dojo)</p>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 space-y-4">
                        <div class="flex items-center gap-2.5 pb-3 border-b border-slate-100">
                            ...
                            <div>
                                <h2 class="text-sm font-bold text-slate-800">Data Asal Sekolah / Instansi</h2>
                                <p class="text-[11px] text-slate-500">Khusus untuk anggota Kohai dari luar kampus Polindra</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="institution" id="institution" value="{{ old('institution', $profile->institution) }}" required
                                ...
                                class="w-full px-4 py-2.5 rounded-xl border @error('institution') border-red-500 bg-red-50/30 @else border-slate-200 bg-slate-50/50 @enderror text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white transition">
                            @error('institution')
                                <p class="text-xs text-red-600 mt-1 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
                    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2.5 bg-slate-50/50">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-slate-500">Data identitas diri dan alamat domisili</p>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
                    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2.5 bg-slate-50/50">
                        ...
                        <div>
                            <h2 class="text-sm font-bold text-slate-800">Data Fisik & Kontak Darurat (Opsional)</h2>
                            <p class="text-[11px] text-slate-500">Membantu pelatih dalam penyesuaian porsi latihan & keselamatan</p>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" step="0.1" name="weight" id="weight" value="{{ old('weight', $profile->weight) }}"
                                        ...
                                        class="w-full pl-4 pr-10 py-2.5 rounded-xl border @error('weight') border-red-500 bg-red-50/30 @else border-slate-200 bg-slate-50/50 @enderror text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white transition">
                            ...
                            <div>
                                <label for="height" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
                                    Tinggi Badan (cm)
                                </label>
                                <div class="relative">
                                    <input type="number" step="0.1" name="height" id="height" value="{{ old('height', $profile->height) }}"
                                        placeholder="Contoh: 172"
                                        class="w-full pl-4 pr-10 py-2.5 rounded-xl border @error('height') border-red-500 bg-red-50/30 @else border-slate-200 bg-slate-50/50 @enderror text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white transition">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label for="emergency_contact_name" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
                                ...
                                <input type="text" name="emergency_contact_name" id="emergency_contact_name" value="{{ old('emergency_contact_name', $profile->emergency_contact_name) }}"
                                    ...
                                    class="w-full px-4 py-2.5 rounded-xl border @error('emergency_contact_name') border-red-500 bg-red-50/30 @else border-slate-200 bg-slate-50/50 @enderror text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white transition">
                            ...
                            <div>
                                <label for="emergency_contact_phone" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
                                ...
                                <input type="tel" name="emergency_contact_phone" id="emergency_contact_phone" value="{{ old('emergency_contact_phone', $profile->emergency_contact_phone) }}"
                                    ...
                                    class="w-full px-4 py-2.5 rounded-xl border @error('emergency_contact_phone') border-red-500 bg-red-50/30 @else border-slate-200 bg-slate-50/50 @enderror text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary focus:bg-white transition">
                ...
                <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
                    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2.5 bg-slate-50/50">
                        ...
                        <div>
                            <h2 class="text-sm font-bold text-slate-800">Keamanan Akun & Kata Sandi</h2>
                            <p class="text-[11px] text-slate-500">Kosongkan jika tidak ingin mengganti kata sandi. Wajib menyertakan kata sandi lama jika ingin memperbarui.</p>
                        </div>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden sticky top-24">
                    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2.5 bg-slate-50/50">
                        ...
                        <div>
                            <h2 class="text-sm font-bold text-slate-800">Tingkat Sabuk (Rank)</h2>
                            <p class="text-[11px] text-slate-500">Wajib ditentukan bagi Kohai <span class="text-red-500">*</span></p>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="pt-2 space-y-3">
                            <button type="submit"
                                class="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-brand-primary to-brand-secondary hover:from-brand-primary/90 hover:to-brand-secondary/90 text-white font-bold text-sm shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-brand-secondary focus:ring-offset-2 transition-all duration-200 flex items-center justify-center gap-2">
